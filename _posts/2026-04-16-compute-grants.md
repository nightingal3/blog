...
**Note**: These allocations are for US institutions primarily, but international students at US institutions can also apply (I am an international student). International collaborators are also allowed as far as I can tell, as long as the submitter is at a US institution. [EuroHPC](https://www.eurohpc-ju.europa.eu/index_en) is an alternative for Europeans.
